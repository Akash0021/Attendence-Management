...
<html>
    ...
    <body>
            ...
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="Monthly.jsp">Monthly Report</a></li>
        ...
        <form action=" " method="post">
                ...
                <div class="form-group">
                    <div class="col-md-5">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control" placeholder="Type username to search" autocomplete="on">
            ...
            <br><br>
            <div align="center">
                <button type="submit" class="btn btn-default">Next Report</button>
            </div><br><br>
        </form>
